...
// Composant pour l'écran génération d'histoire "Étape 4"
export default function StoryGenerationStep4Screen({ navigation, route }) {
  const { length, endingType, selectedType, selectedImage, selectedMusic, selectedCharacter } = route.params;
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.containerStep}>
          <Text style={styles.title2}>Étape 4/4 : Récapitulatif</Text>
        </View>
      </ImageBackground>
...
<ScrollView>        
        ...
        <View style={styles.recapSizeStory}>
          <Text style={styles.sizeTextRecap}>{selectedCharacter.firstName}</Text>
        </View>
</ScrollView>
